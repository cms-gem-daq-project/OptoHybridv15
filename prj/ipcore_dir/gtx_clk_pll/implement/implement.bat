...
xst -ifn xst.scr
move gtx_clk_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\gtx_clk_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc gtx_clk_pll_exdes.ucf gtx_clk_pll_exdes

echo 'Running map'
map -timing -pr b gtx_clk_pll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm gtx_clk_pll_exdes -w routed.ncd routed.vhd
cd ..
