...
xst -ifn xst.scr
move gtp_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\gtp_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc gtp_pll_exdes.ucf gtp_pll_exdes

echo 'Running map'
map -timing -pr b gtp_pll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm gtp_pll_exdes -w routed.ncd routed.vhd
cd ..
