...
ngdbuild -uc ..\..\example_design\gtp_top.ucf -p xc6slx150t-fgg676-3 gtp_top.edf gtp_top.ngd
...
ECHO 'Running NGD'
map -register_duplication on -global_opt speed -logic_opt on -retiming on -timing -ol high -w -p xc6slx150t-fgg676-3 -o mapped.ncd gtp_top.ngd
...
netgen -ofmt vhdl -sim -dir . -tm gtp_top -w routed.ncd routed.vhd
