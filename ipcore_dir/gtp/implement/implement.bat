...
ngdbuild -uc ..\..\example_design\gtp_top.ucf -p xc6slx150t-fgg676-3 gtp_top.ngc gtp_top.ngd
...
ECHO 'Running NGD'
map -register_duplication on -global_opt speed -logic_opt on -retiming on -timing -ol high -p xc6slx150t-fgg676-3 -o mapped.ncd gtp_top.ngd
