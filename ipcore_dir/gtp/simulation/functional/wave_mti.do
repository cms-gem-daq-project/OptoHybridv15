...
add wave -noupdate -format Literal -radix hexadecimal /DEMO_TB/gtp_top_i/gtp_i/tile0_gtp_i/RXCHARISK0_OUT
add wave -noupdate -format Literal -radix hexadecimal /DEMO_TB/gtp_top_i/gtp_i/tile0_gtp_i/RXCHARISK1_OUT
...
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile0_gtp_i/RXBYTEISALIGNED0_OUT
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile0_gtp_i/RXBYTEISALIGNED1_OUT
...
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile0_gtp_i/RXRECCLK0_OUT
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile0_gtp_i/RXRECCLK1_OUT
...
add wave -noupdate -divider {Receive Ports - 8b10b Decoder }
add wave -noupdate -format Literal -radix hexadecimal /DEMO_TB/gtp_top_i/gtp_i/tile1_gtp_i/RXCHARISK0_OUT
add wave -noupdate -format Literal -radix hexadecimal /DEMO_TB/gtp_top_i/gtp_i/tile1_gtp_i/RXCHARISK1_OUT
...
add wave -noupdate -divider {Receive Ports - Comma Detection and Alignment }
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile1_gtp_i/RXBYTEISALIGNED0_OUT
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile1_gtp_i/RXBYTEISALIGNED1_OUT
...
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile1_gtp_i/RXRECCLK0_OUT
add wave -noupdate -format Logic /DEMO_TB/gtp_top_i/gtp_i/tile1_gtp_i/RXRECCLK1_OUT
