...
ngdbuild -uc ..\..\example_design\s6_gtpwizard_v1_11_top.ucf -p xc6slx150t-fgg676-3 s6_gtpwizard_v1_11_top.edf s6_gtpwizard_v1_11_top.ngd
...
ECHO 'Running NGD'
map -register_duplication on -global_opt speed -logic_opt on -retiming on -timing -ol high -w -p xc6slx150t-fgg676-3 -o mapped.ncd s6_gtpwizard_v1_11_top.ngd
