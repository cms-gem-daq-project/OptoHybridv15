...
xst -ifn xst.scr
move ext_clk_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ext_clk_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ext_clk_pll_exdes.ucf ext_clk_pll_exdes

echo 'Running map'
map -timing -pr b ext_clk_pll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ext_clk_pll_exdes -w routed.ncd routed.vhd
cd ..
